...
args.add_argument('--e_hidden_dim',type=int,default=4096, help='number of neurons in the hidden layers of encoder')
args.add_argument('--d_hidden_dim',type=int,default=4096, help='number of neurons in the hidden layers of decoder')
args.add_argument('--batchnorm_momentum',type=float, default=0.8, help='momentum for the batchnormalization layers')
args.add_argument('--latent_dim', type=int, default=2048, help='number of neurons in the latent space')
